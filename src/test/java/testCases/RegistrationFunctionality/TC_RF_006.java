...
public class TC_RF_006 extends BaseClass 
  {
	...
	void registration()
	{
		logger.info("**********Started TC1_RF_006***************");
	try
	{
	...
	regPage.clickNoNewsLetterSubscription();
	logger.info("clicked on 'NO' to subscription letter");
	...
	Assert.assertEquals(nl.selctedByDefaultNo(),true);	
	logger.info("news paper subscription bydefault selected 'No'");
	}
	catch(Exception e)
	{
		Assert.fail();
	}
	logger.info("***********************Finished TC1_RF_006******************");
}
